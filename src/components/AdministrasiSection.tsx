...
export default function AdministrasiSection() {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden" id="administrasi">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          ...
          <div className="group relative">
            ...
            <div className="relative bg-white rounded-2xl p-8 shadow-lg border border-[#00633f]/10 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
              ...
              <div className={`text-6xl font-black text-[#00633f] mb-4 text-center ${isLoading ? "animate-pulse" : ""}`}>
                {isLoading ? "-" : stats.totalWarga}
              </div>
              <h3 className="text-xl font-bold text-gray-800 text-center">Total Penduduk</h3>
              <p className="text-sm text-gray-500 text-center mt-2">Jiwa terdaftar</p>
            </div>
          </div>
          ...
          <div className="group relative">
            ...
            <div className="relative bg-white rounded-2xl p-8 shadow-lg border border-[#00633f]/10 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
              ...
              <h3 className="text-xl font-bold text-gray-800 text-center">Laki-Laki</h3>
              <p className="text-sm text-gray-500 text-center mt-2">Penduduk pria</p>
            </div>
          </div>
          ...
          <div className="group relative">
            ...
            <div className="relative bg-white rounded-2xl p-8 shadow-lg border border-[#00633f]/10 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
              ...
              <h3 className="text-xl font-bold text-gray-800 text-center">Perempuan</h3>
              <p className="text-sm text-gray-500 text-center mt-2">Penduduk wanita</p>
            </div>
          </div>
        </div>
      </div>
