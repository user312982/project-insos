...
export default function FasilitasSection() {
    const facilities = [
        ...
        },
        {
            ...
            bgColor: "bg-pink-600",
            features: ["Pembelajaran interaktif", "Permainan edukatif", "Seni dan kreativitas", "Pengembangan karakter"]
        },
        {
            title: "Tempat Pemancingan",
            description: "Area rekreasi keluarga dengan kolam pemancingan yang nyaman untuk refreshing dan mempererat hubungan keluarga.",
    ...
    return (
        <section className="py-16 bg-[#0b5232] relative overflow-hidden" id="fasilitas">
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="text-center mb-12">
                    ...
                    <p className="text-lg text-gray-300 max-w-2xl mx-auto">
                        Berbagai fasilitas lengkap untuk mendukung kehidupan bermasyarakat yang nyaman dan sejahtera
                    </p>
                </div>
                            ...
                            <div className="rounded-3xl border border-white/15 bg-white/10 backdrop-blur-lg shadow-xl hover:shadow-2xl hover:bg-white/15 transition-all duration-300 overflow-hidden h-full">
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="space-y-2">
                                        <h4 className="text-sm font-semibold text-white/80 mb-2">Layanan:</h4>
